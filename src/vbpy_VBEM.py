...
import scipy
import sys
from .ext_src.dirrnd import dirrnd
from .ext_src.forwbackFRET import forwbackFRET
from .ext_src.kldirichlet import kldirichlet
import pdb
...
def vbpy_VBEM(x, mix, prior_par, options):
    """
    :type x:
    :type mix:
    :type priorPar:
